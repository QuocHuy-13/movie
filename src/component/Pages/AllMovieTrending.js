...
import { fetchTrendingmovieWeek } from '../../sevice/API';
...
const MovieTrending = () => {
    ...
    useEffect(() => {
        const fetchAPI = async () => {
            setContent(await fetchTrendingmovieWeek(page));
        }
        fetchAPI();
    }, [page])
        ...
        <div>
            ...
            <div style={{ position: "relative", marginTop: "60px" }} className="container">
                <div className="row mt-5">
                    <div className="col">
                        <p className="font-weight-bold" style={{ color: "#5a606b", textAlign:"center", fontSize:"40px" }}>TRENDING MOVIES</p>
                    </div>
                </div>
